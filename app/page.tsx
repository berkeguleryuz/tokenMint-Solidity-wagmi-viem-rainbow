...
export default function Home() {
  ...
  const renderMintOption = (amountInUSD: number) => (
    <div className="flex flex-col items-center p-8 bg-slate-900 rounded-lg shadow-2xl transition-transform transform hover:scale-105">
      ...
      <Button
        className="bg-gradient-to-r from-yellow-500 to-orange-500 text-white font-bold py-3 px-6 rounded-full hover:from-yellow-600 hover:to-orange-600 transition duration-300"
      ...
      <div className="p-5 grow flex flex-col items-center justify-center">
          <>
            ...
            <div className="mt-8 w-full max-w-3xl">
              ...
              {isConfirming && (
                <Alert className="bg-yellow-500 text-white mt-2">
